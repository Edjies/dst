...
import com.haofeng.apps.dst.utils.clusterutil.clustering.algo.Algorithm;
import com.haofeng.apps.dst.utils.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm;
import com.haofeng.apps.dst.utils.clusterutil.clustering.algo.PreCachingAlgorithmDecorator;
import com.haofeng.apps.dst.utils.clusterutil.clustering.view.ClusterRenderer;
import com.haofeng.apps.dst.utils.clusterutil.clustering.view.DefaultClusterRenderer;
...
public class ClusterManager<T extends ClusterItem> implements
	...
	public void onMapStatusChange(MapStatus mapStatus) {
		if (mRenderer instanceof BaiduMap.OnMapStatusChangeListener) {
			((BaiduMap.OnMapStatusChangeListener) mRenderer)
					.onMapStatusChange(mapStatus);
		}
