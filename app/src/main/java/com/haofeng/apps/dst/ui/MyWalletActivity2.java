 ...
 * @author WIN10
 */
public class MyWalletActivity2 extends BaseActivity implements OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.activity_mywallet_yajin_tixian: // 押金提现
                ...
                AnsynHttpRequest.httpRequest(MyWalletActivity2.this, AnsynHttpRequest.GET, callBack, Constent.ID_ACT_YAJINTIXIAN, map, false, false, true);
                break;
                                ...
                                if (!isString) {
                                    ...
                                    try {
                                        ...
                                        if (orderObject != null) {
                                            ...
                                            AlertDialog dialog = new AlertDialog.Builder(MyWalletActivity2.this).create();
                                            View view = View.inflate(MyWalletActivity2.this, R.layout.view_yajin_no_huanche, null);
                                            dialog.setView(view);
                            ...
                            if (isRequestSuccess) {
                                if (!isString) {
                                    try {
                                        ...
                                        AlertDialog.Builder builder = new AlertDialog.Builder(MyWalletActivity2.this);
                                        final AlertDialog dialog = builder.create();
                                        if ("1112".equals(jsonObject.getString("errcode"))) {   //1.判断押金金额 2.判断订单 3.判断违章
                                            ...
                                            if (remark != null && remark.equals("ARREARS")) {
                                                if (foregift_acount == 0) {
                                                    Toast.makeText(MyWalletActivity2.this, "押金账户为0，无法提现", Toast.LENGTH_SHORT).show();
                                                } else {
                                                    View view = View.inflate(MyWalletActivity2.this, R.layout.view_yajin_lower_zero, null);
                                                    dialog.setView(view);
                                                    ...
                                                    congzhiTextView.setOnClickListener(new OnClickListener() {
                                                        @Override
                                                        public void onClick(View v) {
                                                            Intent intent = new Intent(MyWalletActivity2.this, RechargeActivity.class);
                                                            intent.putExtra("type", "rent_car_yajin");
                                                            intent.putExtra("infor", "租车押金充值");
                                                            intent.putExtra("infor2", "地上铁App租车押金充值");
                                                ...
                                                AnsynHttpRequest.httpRequest(MyWalletActivity2.this, AnsynHttpRequest.GET, callBack, Constent.ID_ORDER_GET_DETAIL, map, false, false, true);
                                            ...
                                            Intent intent = new Intent(MyWalletActivity2.this, ReturnMoneyActivity.class);
                                            startActivity(intent);
