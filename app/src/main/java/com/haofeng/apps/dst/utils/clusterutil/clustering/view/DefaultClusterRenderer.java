...
package com.haofeng.apps.dst.utils.clusterutil.clustering.view;
...
import com.haofeng.apps.dst.utils.clusterutil.MarkerManager;
import com.haofeng.apps.dst.utils.clusterutil.clustering.Cluster;
...
import com.haofeng.apps.dst.utils.clusterutil.projection.Point;
import com.haofeng.apps.dst.utils.clusterutil.projection.SphericalMercatorProjection;
import com.haofeng.apps.dst.utils.clusterutil.ui.IconGenerator;
import com.haofeng.apps.dst.utils.clusterutil.ui.SquareTextView;
...
import static com.haofeng.apps.dst.utils.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements
	 ...
	 */
	private static final int MIN_CLUSTER_SIZE = 5;// 这个是设置聚合的点数的最小值
	...
	public DefaultClusterRenderer(Context context, BaiduMap map,
	...
	private SquareTextView makeSquareTextView(Context context) {
		...
		squareTextView.setId(R.id.map_clustertextview);
	...
	private class CreateMarkerTask {
		...
		private void perform(MarkerModifier markerModifier) {
				...
				for (T item : cluster.getItems()) {
					...
					if (marker == null) {
						...
						if (animateFrom != null) {
							...
							markerOptions.extraInfo(item.getBundle());// 这里在画点
						} else {
			...
			Marker marker = mClusterManager.getClusterMarkerCollection()
					.addMarker(markerOptions);
			mMarkerToCluster.put(marker, cluster);
			mClusterToMarker.put(cluster, marker);
			MarkerWithPosition markerWithPosition = new MarkerWithPosition(
					marker);
			if (animateFrom != null) {
